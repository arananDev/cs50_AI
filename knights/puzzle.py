...
knowledge1 = And(
    ...
    Implication(AKnave, Or(And(AKnight, BKnave), And(BKnight, AKnave), And(AKnight, BKnight),)),
...
knowledge2 = And(
    ...
    Implication(AKnave, Or(And(AKnave, BKnight), And(BKnave, AKnight))),
...
knowledge3 = And(
    ...
    Implication(AKnave, And(AKnight, AKnight)),
